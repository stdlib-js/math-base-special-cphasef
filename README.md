...
```javascript
import cphasef from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-cphasef@v0.1.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-cphasef/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/math-base-special-cphasef/actions/workflows/test.yml?query=branch:v0.1.1
